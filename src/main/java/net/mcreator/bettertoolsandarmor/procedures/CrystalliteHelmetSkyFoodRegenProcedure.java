...
public class CrystalliteHelmetSkyFoodRegenProcedure {
	...
	private static void execute(@Nullable Event event, Entity entity, ItemStack itemstack) {
		...
		if (IsWearingArmorTagProcedure.execute(entity, "better_tools:carbonated_drinks_armor")) {
			if (itemstack.is(ItemTags.create(ResourceLocation.parse("c:drinks"))) || itemstack.is(ItemTags.create(ResourceLocation.parse("c:drink_containing"))) || itemstack.is(ItemTags.create(ResourceLocation.parse("c:foods/soup")))) {
